...
// midiCtl.cpp : DLL エクスポートのインプリメンテーション


// メモ: Proxy/Stub 情報
//  別々の proxy/stub DLL をビルドするためには、プロジェクトのディレクトリで 
//      nmake -f midiCtlps.mak を実行してください。
...
OBJECT_ENTRY(CLSID_midiOutInfo, CmidiOutInfo)
OBJECT_ENTRY(CLSID_midiOutCaps, CmidiOutCaps)
END_OBJECT_MAP()
...
BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID /*lpReserved*/)
{
    ...
    {
        _Module.Init(ObjectMap, hInstance, &LIBID_MIDICTLLib);
